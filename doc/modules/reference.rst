================================================
Reference documentation: all nidata datasets
================================================

This is the class and function reference of nidata. Please refer to
...
:mod:`nidata.anatomical`: Automatic Dataset Fetching
===================================================

.. automodule:: nidata.anatomical
   :members:
   :undoc-members:

**User guide:** See the :ref:`anatomical` section for further details.
