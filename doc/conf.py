# -*- coding: utf-8 -*-
#
# nidata documentation build configuration file, created by
...
# We also add the directory just above to enable local imports of nidata
...
project = u'Nidata'
copyright = u'The nidata developers 2015'
...
html_title = "Public data for NeuroImaging"

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = 'Nidata'

# The name of an image file (relative to this directory) to place at the top
# of the sidebar.
html_logo = 'logos/nidata-logo.png'
...
# [howto/manual]).
latex_documents = [
  ('index', 'nidata.tex', u'NeuroImaging via public data',
   ur"""Gaël Varoquaux and Alexandre Abraham"""
   + r"\\\relax ~\\\relax http://nidata.github.io",
   'manual'),
...
# the title page.
latex_logo = "logos/nidata-logo.png"
