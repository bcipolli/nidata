=====================================
Introduction: nidata in a nutshell
=====================================
...
What is nidata: data curation, documentation, examples
===========================================================================

.. topic:: **Why use nidata?**

    Nidata makes it easy to discover, download, and make use of **publicly 
    available** **neuroimaging** data. These include data acquired through:
    MRI, fMRI, rsMRI, dMRI

    Nidata simplifies the download of these data, puts them into a common
    data format, and provides examples for their usage and visualization.


Why is publicly available data important to NeuroImaging? A few examples!
-----------------------------------------------------------------
...
Glossary: data access vocabulary
--------------------------------------
...
to realize that most things you will do in nidata require only a few or a
